...
public class OrderBookingAddAdapter extends BaseAdapter {
	...
	public OrderBookingAddAdapter(Context pContext, long activityID) {
	...
	public View getView(final int position, View convertView,
		...
		product.setText(((SKUProductList) bookingOrderData.get(position))
				.getSKUCode().toString());
		qty.setText(((SKUProductList) bookingOrderData.get(position))
				.getQuantity().toString());
		value.setText(((SKUProductList) bookingOrderData.get(position))
		...
		delete.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (bookingOrderData.size() == 1 && mActivtyID != -1) {
					...
					Helper.showAlertDialog(
							...
							/*		boolean result = DatabaseHelper
									...
									if (rowEffectedInOrderTable != 0
										...
										BookOrder order = (BookOrder) context;
										order.refreshTotal();
									}
					...
					Helper.showAlertDialog(
							...
							new SSCAlertDialog.OnSDAlertDialogClickListener() {
								...
								public void onClick(
									...
									bookingOrderData.remove(position);
	...
	public BookingOrderArrayList getItems() {
	...
	private void showPopUp(final int position) {
		...
		qty.setText(((SKUProductList) bookingOrderData.get(position))
				.getQuantity().toString());
		Double dpValue = Double.valueOf(((SKUProductList) bookingOrderData
				.get(position)).getDealerPrice().toString());
		Double dValueqty = Double.valueOf(((SKUProductList) bookingOrderData
		...
		okButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				((SKUProductList) bookingOrderData.get(position))
						.setQuantity(qty.getText().toString().trim());

				int qty = Integer.valueOf(((SKUProductList) bookingOrderData
						.get(position)).getQuantity().toString());
