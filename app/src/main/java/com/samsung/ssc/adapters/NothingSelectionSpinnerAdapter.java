 ...
 */
public class NothingSelectionSpinnerAdapter implements SpinnerAdapter, ListAdapter {
     ...
     * @param context
     */
    public NothingSelectionSpinnerAdapter(SpinnerAdapter spinnerAdapter,int nothingSelectedLayout, Context context) {
     ...
     * @param context
     */
    public NothingSelectionSpinnerAdapter(SpinnerAdapter spinnerAdapter,
